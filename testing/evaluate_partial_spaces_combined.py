...
DATABASE_FILE= 'generating_queries/partial_spaces_evaluation_database_not_centered_0.25.5.pickle'
QUERY_FILE= 'generating_queries/partial_spaces_evaluation_query_not_centered_0.25.5.pickle'

LOG_DIR = 'log/'
MODEL_DIR = 'baseline/'
output_file= RESULTS_FOLDER +'results_partial_spaces_combined_0.25.5.txt'
