...
base_path = "../jittered_dataset_4096/"
...
def construct_query_dict(df_centroids, filename):
	tree = KDTree(df_centroids[['northing','easting','alting']])
	ind_nn = tree.query_radius(df_centroids[['northing','easting','alting']],r=5) # r=4, 1
	ind_r = tree.query_radius(df_centroids[['northing','easting','alting']], r=15) # r=10, 15
	queries={}
...
df_train= pd.DataFrame(columns=['file','northing','easting','alting'])
...
construct_query_dict(df_train,"3d_4m_jittered_training_queries_4096.pickle")
print("Number of non-disjoint test submaps: "+str(len(df_test['file'])))
construct_query_dict(df_test,"3d_4m_jittered_test_queries_4096.pickle")
