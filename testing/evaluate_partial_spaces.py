...
LOG_DIR = 'log/'
MODEL_DIR = 'baseline/'
model_file= "model_p1_n15.ckpt" #"model_baseline.ckpt"#
...
def evaluate(DATABASE_SETS, QUERY_SETS, output_file):
    global DATABASE_VECTORS
    global QUERY_VECTORS
...
if __name__ == "__main__":
    ...
    for radius in np.arange(0.25,3.1,0.25)[:file_list]:
        ...
        print("Doing",radius)
    """    
    DATABASE_FILE = 'generating_queries/partial_spaces/partial_radius_2.0_evaluation_database.pickle'
    QUERY_FILE = 'generating_queries/partial_spaces/partial_radius_2.0_evaluation_query.pickle'

    output_file = RESULTS_FOLDER +'results_partial_spaces_2.0.txt'#'+str(radius)+'.txt'

    DATABASE_SETS= get_sets_dict(DATABASE_FILE)
    QUERY_SETS= get_sets_dict(QUERY_FILE)

    evaluate(DATABASE_SETS, QUERY_SETS, output_file)
