...
DATABASE_FILE= 'generating_queries/vertical_spaces_evaluation_database.pickle'
QUERY_FILE= 'generating_queries/vertical_spaces_evaluation_query.pickle'

LOG_DIR = 'log/'
MODEL_DIR = 'baseline/'
output_file= RESULTS_FOLDER +'results_vertical.txt'
