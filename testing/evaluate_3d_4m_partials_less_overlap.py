...
def evaluate(QUERY_SETS, output_file):
    ...
    with tf.Graph().as_default():
        ...
        with open(RESULTS_FOLDER +'results.pickle','wb') as pickle_output:
...
if __name__ == "__main__":
    ...
    for radius in np.arange(0.25,2.1,0.25):
        ...
        QUERY_FILE = 'queries/3d_partial_radius_{}_evaluation_query_r15_less_overlap.pickle'.format(radius)
    
        print("Doing",QUERY_FILE)
    
        output_file = RESULTS_FOLDER +'results_partial_spaces_'+str(radius)+'.txt'
