...
DATABASE_FILE= 'generating_queries/spatial_privacy_evaluation_database_not_centered_1.0.pickle'
QUERY_FILE= 'generating_queries/spatial_privacy_evaluation_query_not_centered_1.0.pickle'

LOG_DIR = 'log/'
MODEL_DIR = 'baseline/'
output_file= RESULTS_FOLDER +'results_not_centered_1.0.txt'
